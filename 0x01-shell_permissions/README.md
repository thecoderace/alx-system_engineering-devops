...
## What is the Shell, Permissions?

The chmod command is used to change the permissions of a file or directory. Using the command, we can set permissions (read, write, execute) on a file/directory for the owner, group and the world.
...
[10-mirror_permissions](./110-mirror_permissions) - Write a script that sets the mode of the file `hello` the same as `olleh’s` mode.
